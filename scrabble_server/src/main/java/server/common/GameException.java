...
public class GameException extends Exception {
    ...
    public enum typeErr {
        ...
        NEW_GAME_ANONYM_ERROR, XML_FILE_NOT_EXISTS, DELETE_ANONYM_ERROR, TILE_EXCHANGE_ERROR,
        PLACE_WORD_ERROR, GAME_IDENT_ERROR, LOAD_GAME_ERROR, LOGOUT_ERROR, SAVE_GAME_ERROR,UNDO_ERROR};
    private typeErr err;
