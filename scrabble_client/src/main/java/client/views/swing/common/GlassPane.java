...
/**
 * Hidden, by default. If you make the glass pane visible, then it's like a
 * sheet of glass over all the other parts of the root pane.
 *
...
public class GlassPane extends JPanel {
    ...
    /**
     * Bill Pugh's Singleton solution The nested class is referenced no earlier
     * (and therefore loaded no earlier by the class loader) than the moment
