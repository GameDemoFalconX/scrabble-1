...
public class BlankDialog extends JDialog {
		...
		private static final String PATH_TILE = "/views/swing/media/";
		private static final String PATH_LETTER = "/views/swing/media/letters/";
		private static final String PATH_NUMBER = "/views/swing/media/numbers/";
