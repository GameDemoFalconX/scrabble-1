...
/**
 * This class represents a panel grid which might be contain a DTElement (On the game board)
...
public class panelGrid extends JPanel {
		...
		/**
			...
			* @param tw (tile width), @param th (tile height), @param coord (coordinates inside the grid) 
			*/
